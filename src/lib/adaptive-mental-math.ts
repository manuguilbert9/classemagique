...
const allCompetencies: MentalMathCompetency[] = [
    ...
    { id: 'B2', level: 'B', description: 'Valeur de position (unités, dizaines)', generate: () => { const n = randInt(10, 99); const type = choice(['dizaines', 'unités']); const ans = type === 'dizaines' ? Math.floor(n/10) : n % 10; return { question: `Combien de ${type} dans ${n} ?`, answer: String(ans) }; } },
