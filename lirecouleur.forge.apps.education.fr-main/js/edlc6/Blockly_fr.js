...
Blockly.Msg.base_define_const_tooltip =
  "permet au programmeur de donner un nom à une valeur quelconque";
...
Blockly.Msg.CONTROLS_SWITCH_TOOLTIP_1 =
  "Si une valeur est vraie alors exécuter les commandes suivantes";
Blockly.Msg.CONTROLS_SWITCH_TOOLTIP_2 =
  "Si une valeur est vraie alors exécuter le premier bloc de commandes. Sinon exécuter le bloc suivant de commandes";
Blockly.Msg.CONTROLS_SWITCH_TOOLTIP_3 =
  "Si une valeur est vraie alors exécuter le premier bloc de commandes. Sinon exécuter le bloc suivant de commandes si la condition est vraie";
Blockly.Msg.CONTROLS_SWITCH_TOOLTIP_4 =
  "Si une valeur est vraie alors exécuter le premier bloc de commandes. Sinon exécuter le bloc suivant de commandes si la condition est vraie.  Si aucune condition n'est vérifiée, alors faire le bloc de commandes par défaut";
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING =
  "Attention : Ce bloc doit être utilisé dans une boucle";
...
Blockly.Msg.LISTS_CREATE_TOOLTIP =
  "Créé une liste avec le nombre d'éléments désiré";
...
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TOOLTIP =
  "Ajouter, supprimer, ou réordonner";
Blockly.Msg.LISTS_CREATE_WITH_INPUT_WITH = "graphèmes :";
Blockly.Msg.LISTS_CREATE_WITH_ITEM_TOOLTIP = "Ajouter un élément";
Blockly.Msg.LISTS_CREATE_WITH_TOOLTIP =
  "retourne un tableau ou liste avec un nombre quelconque d’éléments";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FIRST =
  "retourne le premier élément dans une liste";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM =
  "retourne l’élément à la position indiquée dans une liste";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_LAST =
  "retourne le dernier élément dans une liste";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FIRST =
  "Supprime et retourne le premier élément dans une liste";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FROM =
  "Supprime et retourne l’élément à la position indiquée dans une liste";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_LAST =
  "Supprime et retourne le dernier élément dans une liste";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_RANDOM =
  "Supprime et retourne un élément au hasard dans une liste";
...
Blockly.Msg.LISTS_INDEX_OF_TOOLTIP =
  "retourne l’index de la première/dernière occurrence de l’élément dans la liste. retourne %1 si l'élément n'est pas trouvé";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_EQ =
  "retourne vrai si les deux entrées sont égales";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GT =
  "retourne vrai si la première entrée est plus grande que la seconde";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_GTE =
  "retourne vrai si la première entrée est plus grande ou égale à la seconde";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LT =
  "retourne vrai si la première entrée est plus petite que la seconde";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LTE =
  "retourne vrai si la première entrée est plus petite ou égale à la seconde";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_NEQ =
  "retourne vrai si les deux entrées sont différentes";
...
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_AND =
  "retourne vrai si les deux entrées sont vraies";
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_OR =
  "retourne vrai si au moins une des entrées est vraie";
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_xor =
  "retourne vrai si seulement une des entrées est vraie";
...
Blockly.Msg.LOGIC_TERNARY_TOOLTIP =
  "Vérifier la condition dans 'test'. Si elle est vraie, retourne la valeur 'si vrai' ; sinon retourne la valeur 'si faux'";
...
Blockly.Msg.MATH_ARITHMETIC_TOOLTIP_POWER =
  "retourne le premier nombre élevé à la puissance du second";
...
Blockly.Msg.MATH_CONSTANT_TOOLTIP =
  "retourne une des constantes courantes : π (3.141…), e (2.718…), φ (1.618…), sqrt(2) (1.414…), sqrt(½) (0.707…), ou ∞ (infini)";
...
Blockly.Msg.MATH_IS_TOOLTIP =
  "retourne vrai ou faux si un nombre est pair, impair, premier, entier, positif, négatif, ou s’il est divisible par un certain nombre";
Blockly.Msg.MATH_IS_WHOLE = "est entier";
Blockly.Msg.MATH_MODULO_TITLE = "reste de %1 ÷ %2";
Blockly.Msg.MATH_MODULO_TOOLTIP =
  "retourne le reste de la division euclidienne des deux nombres";
...
Blockly.Msg.PROCEDURES_DEFNORETURN_TOOLTIP =
  "Crée une procédure ou fonction sans retour de donnée";
Blockly.Msg.PROCEDURES_DEFRETURN_RETURN = "retourner";
Blockly.Msg.PROCEDURES_DEFRETURN_TOOLTIP =
  "Crée une procédure ou fonction avec un renvoi de donnée";
...
Blockly.Msg.tab_create_fix =
  "Créer le bloc 'mettre un élément du tableau %1 à'";
...
Blockly.Msg.ARRAY_CREATE_WITH_TOOLTIP =
  "retoune une liste avec un certain nombre d'éléments";
...
Blockly.Msg.TEXT_JOIN_TOOLTIP =
  "retourne un texte en agrégeant un nombre quelconque d’éléments";
Blockly.Msg.TEXT_LENGTH_TITLE = "longueur de %1";
Blockly.Msg.TEXT_LENGTH_TOOLTIP =
  "retourne le nombre de lettres (espaces compris) du texte fourni";
...
//other
Blockly.Msg.discard =
  "Supprimer tous les blocs pour commencer un nouveau programme ?";
Blockly.Msg._AT = "à";
...
Blockly.Msg.VARIABLES_GET_CREATE_SET =
  "Créer le bloc 'mettre la variable %1 à'";
...
Blockly.Msg.var_set_init_tooltip =
  "Déclare et initialise la variable du type et de la valeur indiqués";
Blockly.Msg.ARDUINO_VAR_CONST = "déclarer la constante";
Blockly.Msg.ARDUINO_VAR_CONST_tooltip =
  "Déclare une constante du type et de la valeur indiqués";
