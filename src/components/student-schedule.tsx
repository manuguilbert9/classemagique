...
function SortableStep({ step, isCurrent, isCompleted, onToggle, onRemove, onUpdate }: { 
    ...
    const IconComponent = (AllIcons as any)[step.icon as IconName] || AllIcons.Pen;
    const EditIconComponent = (AllIcons as any)[editIcon as IconName] || AllIcons.Pen;
    ...
    return (
        <div ref={setNodeRef} style={style} {...attributes} className={cn(
            ...
            {isEditing ? (
                <>
                    <EditIconComponent className="h-8 w-8 text-primary" />
