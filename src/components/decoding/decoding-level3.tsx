...
const realWords: RealWord[] = [
    { word: 'narine', syllables: ['na', 'ri', 'ne'], silent: 'e' },
    { word: 'tomate', syllables: ['to', 'ma', 'te'], silent: 'e' },
    { word: 'farine', syllables: ['fa', 'ri', 'ne'], silent: 'e' },
    { word: 'tétine', syllables: ['té', 'ti', 'ne'], silent: 'e' },
    { word: 'saleté', syllables: ['sa', 'le', 'té'], silent: '' },
    { word: 'relire', syllables: ['re', 'li', 're'], silent: 'e' },
    { word: 'marine', syllables: ['ma', 'ri', 'ne'], silent: 'e' },
    { word: 'affalé', syllables: ['af', 'fa', 'lé'], silent: '' },
    { word: 'rassure', syllables: ['ras', 'su', 're'], silent: 'e' },
    { word: 'numéro', syllables: ['nu', 'mé', 'ro'], silent: '' },
    { word: 'assure', syllables: ['as', 'su', 're'], silent: 'e' },
    { word: 'tatami', syllables: ['ta', 'ta', 'mi'], silent: '' },
    { word: 'anime', syllables: ['a', 'ni', 'me'], silent: 'e' },
    { word: 'totale', syllables: ['to', 'ta', 'le'], silent: 'e' },
