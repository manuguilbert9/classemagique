...
export interface MentalMathQuestion extends Omit<Question, 'id'|'question'|'level'|'answer'> {
    id: number;
    question: string;
    answer: number;
    level: SkillLevel;
...
const generateLevelA = (): Question => {
    ...
    return { id: Date.now() + Math.random(), type: 'qcm', question, answer: String(answer), level: 'A', visuals };
};
...
const generateLevelB = (): Question => {
    ...
    return { id: Date.now() + Math.random(), type: 'qcm', question, answer: String(answer), level: 'B' };
};
...
const generateLevelC = (): Question => {
    ...
    return { id: Date.now() + Math.random(), type: 'qcm', question, answer: String(answer), level: 'C' };
};
...
const generateLevelD = (): Question => {
    ...
    return { id: Date.now() + Math.random(), type: 'qcm', question, answer: String(answer), level: 'D' };
};
