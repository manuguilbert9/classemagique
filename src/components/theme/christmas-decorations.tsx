...
export function ChristmasDecorations() {
    ...
    return (
        <div className="fixed inset-0 pointer-events-none z-40 overflow-hidden">
            ...
            {/* Top Center Garland */}
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-4xl h-24 md:h-32">
                <Image
            ...
            {/* Bottom Winter Scene */}
            <div className="absolute bottom-0 left-0 w-full h-32 md:h-48 opacity-60">
                <Image
